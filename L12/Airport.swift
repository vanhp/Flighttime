...
extension Airport:  Comparable {
    static func withICAO(_ icao: String, context: NSManagedObjectContext) -> Airport {
        ...
        if let airport = airports.first {
            ...
            // intially may be mostly empty might to call update to
            // fill them in later
    ...
    // fetch flights data from flightaware site async
    ...
    // update DB and notify the view to redraw themself
    ...
    // work around convert swift type to NSSet
